...
5. Enemies telegraph their **Tactics**
...
Fire heavy weapons, call in airstrikes, or use other equipment. See *Equipment & Gear*. Some gear takes a whole Exchange to use.
...
The entire Squad retreats and all Troopers fall back. Each Trooper rolls to see if they take an [[Injury]], depending on current Momentum. Survivors flee to the previous Sector.
...
**Pushed Back.** Lose −1 Momentum. If Momentum reaches DEFEAT, the Squad is routed, as per the Disengage intent.

**Hold Position.** Each Trooper gains +1 DEF this Exchange. No Momentum change.

**Success at a Cost.** Gain +1 Momentum. −1 DEF for the most at-risk Trooper (most injured in the worst Defensive Position). If this applies to multiple Troopers, pick one at random. This Trooper also takes +1 Injury if hit. If this Momentum gain pushes Momentum to VICTORY, make one final Defense Roll for all Troopers, in which it's not possible to go Suppressed.

**Success.** Gain +1 Momentum. If you roll a number of 6s ≥ Threat Level + 1, gain 1 additional Momentum (so never more than +2 Momentum per Exchange). If this Momentum gain pushes Momentum to VICTORY, the Engagement is won.
...
| ---------------- | ------------ |
| 1 — Light        | 1 Injury     |
| 2 — Standard     | {roll:1d2|Injuries} Injuries |
| 3 — Heavy        | {roll:1d3|Injuries} Injuries |
| 4 — Overwhelming | {roll:1d4|Injuries} Injuries |
...
When fighting serious threats, the enemy will prepare for certain strategies at the end of an Exchange. The Troopers can see these coming, and can prepare accordingly. Roll {roll:1d6|Tactic check} — if the roll is equal or under the Threat Level, roll {roll:1d6|Tactic} to see which tactic is applied.

| d6 | Tactic                                                                                            | Description                                                          |
| -- | ------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| 1  | **Quick Flank.** One random Fortified Trooper is now Flanked.                                    | An enemy unit slips past defenses to threaten a fortified position.  |
| 2  | **Encircle.** All Fortified Troopers are now In Cover.                                            | The squad's positions are compromised by encroaching enemies.        |
| 3  | **Push Forward.** All Troopers reduce their Defensive Position by 1 step.                         | The enemy presses the attack, forcing everyone to adjust or take fire. |
| 4  | **Reposition.** One Flanking Trooper is now Engaged.                                              | An enemy maneuver cuts off their advance route.                      |
| 5  | **Fall Back.** All Flanking Troopers are now Engaged.                                             | The squad's flanking efforts collapse under enemy counter-pressure.  |
| 6  | **Scatter.** A grenade lands at the feet of a random Trooper. They must Move during the next Exchange or take +1 Injury. | The battlefield erupts in chaos — act fast or pay the price.        |
